...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { duration: @title.duration, file: @title.file, resume: @title.resume, title: @title.title } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { duration: @title.duration, file: @title.file, resume: @title.resume, title: @title.title } }
